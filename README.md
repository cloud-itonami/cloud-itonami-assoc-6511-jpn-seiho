# cloud-itonami-assoc-6511-jpn-seiho

Industry self-regulatory rule catalog for **The Life Insurance
Association of Japan** (一般社団法人 生命保険協会 / LIAJ, seiho) — a 10th
industry-association-level source, and the FIRST aligned to ISIC 6511
(life insurance, distinct from sonpo's ISIC 6512 general/non-life
insurance), alongside
...
remains LIAJ's; this repo stores only citation metadata (id/title/url/
